...
templates['twoot_single'] = template({"1":function(depth0,helpers,partials,data) {
    var stack1;
  ...
  return ((stack1 = helpers['with'].call(depth0,(depth0 != null ? depth0.twoot : depth0),{"name":"with","hash":{},"fn":this.program(1, data, 0),"inverse":this.noop,"data":data})) != null ? stack1 : "");
},"usePartial":true,"useData":true});
